...
// 	document.addEventListener("click", documentActions);
	...
	// 		if (targetElement.classList.contains('hello__button')) {
	// 			targetElement.closest('.item-portfolio__content').classList.toggle('_hover');
	// 		}
			// if (targetElement.classList.contains('item-portfolio__title')) {
			// 	targetElement.closest('.item-portfolio__content').classList.toggle('_hover');
			// }
			// if (!targetElement.closest('.item-portfolio__content') && document.querySelectorAll('.item-portfolio__content._hover').length > 0) {
			// 	_removeClasses(document.querySelectorAll('.item-portfolio__content._hover'), "_hover");
			// }
// 		}
...
// //  обрщаемся практически к тегу html 
...
// // Ширина и высота с полосой прокрутки

// const windowWidth_2 = window.innerWidth;
// const windowHeight_2 = window.innerHeight;

// console.log(windowWidth_2);
// console.log(windowHeight_2);
...
function setScrollIntoView(top)  {
	const lessonSelected = document.querySelector('.about__title) ;
